...
import sys
sys.path.append("src")
from retrieval.utils import RetrievalSystem, DocExtracter
from retrieval.template import *
...
class MedRAG:
    ...
    def __init__(self, llm_name="OpenAI/gpt-4-1106-preview-nofilter", rag=True, follow_up=False, retriever_name="MedCPT", corpus_name="Textbooks", db_dir="./corpus", cache_dir=None, corpus_cache=False, HNSW=False):
